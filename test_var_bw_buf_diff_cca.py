...
if __name__ == '__main__':
  ...
  large_sizes = ["30000000"] #10MB,30MB
  small_sizes = ["500000"] #1MB,1MB
  ...
  #bws=["40mbit"]
  #buff_sizes =["10","20","40","80","160"]
  
  buff_sizes=["320","640","960","1280","1600","1920","2240"] #8*BDP -fifth
  #buff_sizes=["160","320","480","640","800","960","1120"] #4*BDP -fourth
  #buff_sizes=["80","160","240","320","400","480","560"] #2*BDP - second
  #buff_sizes=["40","80","120","160","200","240","280"] #BDP - first - Done
  #buff_sizes=["20","40","60","80","100","120","140"] #1/2*BDP -third
  #buff_sizes=["10","20","30","40","50","60","70"] #1/4*BDP -sixth
  ...
  #inter_small_spaces =[0.1,0.2,0.3,0.4] # [0.0, 0.05, 0.1, 0.2, 0.4]
  space = 0.1;
		 ...
		 for waittime in waittimes:
		   #for space in inter_small_spaces:
			...
			outname= ("%s_%sMB_%s_%s_%sMB_%s_%s_%sbuf_%sperc_%s_%sgap_%s" %(large_prot,large_size,large_dl,small_prot,small_size,small_dl,bw,buff,lr,waittime,space,ite))
  			...
  			#p1 = Process(target=succesive_small_flows,args=(rep,waittime,small_serv_port,small_clie_port,small_prot,small_size,small_dl,bw,large_size,large_prot,large_dl,ite,buff,space,outname))#for two competing short flow test
