...
thrpt_or_gdpt=1; %if 1 calculate thrpt else calculate goodput

for bw_idx = 1:1 %length(bws)
    bw=bws(bw_idx);
    for bdp_idx=2:3%buf_dim(2)
        buf=buffs(bw_idx,bdp_idx);
        for idx = 1:2 %length(ccas)-1
                cca_small=ccas(idx);

                file1=char(strcat(dir,cca_large,'_',l_data,'_',rtt,'_',cca_small,'_',s_data,'_',rtt,'_',bw,'_',buf,'_',lr,'_',sch,'_',space,'_',iter,'_',analyzed_flow,'_',file_end1))
                file2=char(strcat(dir,cca_large,'_',l_data,'_',rtt,'_',cca_small,'_',s_data,'_',rtt,'_',bw,'_',buf,'_',lr,'_',sch,'_',space,'_',iter,'_',analyzed_flow,'_',tstamp_end))
                file3=char(strcat(dir,cca_large,'_',l_data,'_',rtt,'_',cca_small,'_',s_data,'_',rtt,'_',bw,'_',buf,'_',lr,'_',sch,'_',space,'_',iter,'_',analyzed_flow,'_',rtt_end))
                ...
                if thrpt_or_gdpt==1    
                    ...
                    durs=T-T(1);% in ms
                    thrpt_tstamp=B(1:length(durs))./durs;
